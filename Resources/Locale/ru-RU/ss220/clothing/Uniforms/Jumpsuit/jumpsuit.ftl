...
ent-ClothingUniformJumpsuitExpeditor = униформа экспедитора
    ...
    .suffix = За время в игре
ent-ClothingUniformJumpsuitCommissar = китель комиссара
    .desc = Комиссар не требует уважения. Он его олицетворяет.
    .suffix = За время в игре
ent-ClothingUniformJumpsuitJRSalvage = комбинезон утилизатора JR
    .desc = Обеспечивает повышенный комфорт во время ликвидации беспорядка.
    .suffix = { ent-ClothingUniformJumpsuitExpeditor.suffix }
